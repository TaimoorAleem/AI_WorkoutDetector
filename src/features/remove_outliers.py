...
# Technique 1: Interquartile range (distribution based)
...
# Technique 2: Chauvenets criteron (distribution based)
...
# Technique 3: Local outlier factor (distance based)
...
# Check outliers grouped by label for each of the 3 techniques defined above
label = "bench"
