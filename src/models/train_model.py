...
# Commented the results of the forward selection to avoid running it again, as it takes a long time to run.
''' 
...
# Selecting RF as our best model and evaluate results
...
# Select train and test data based on participant A, as it is the one with the least data and we want to test our model on it to see how it generalizes to new participants.
